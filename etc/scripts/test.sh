...
then
	...
	then
		...
		cmd="${cmd} :jdroid-android-firebase-admob:assemble :jdroid-android-firebase-admob:testDebug :jdroid-android-firebase-admob:lintDebug"
		cmd="${cmd} :jdroid-android-firebase-crash:assemble :jdroid-android-firebase-crash:testDebug :jdroid-android-firebase-crash:lintDebug"

...
public final class AccessToken implements Serializable {
	...
	AccessToken(String token, Date expires, List<String> permissions, List<String> declinedPermissions,
	...
	static AccessToken createFromTokenWithRefreshedPermissions(AccessToken token, List<String> grantedPermissions,
			List<String> declinedPermissions) {
		return new AccessToken(token.token, token.expires, grantedPermissions, declinedPermissions, token.source,
				token.lastRefresh);
	}
	
	private static AccessToken createNew(List<String> grantedPermissions, List<String> declinedPermissions,
	...
	Bundle toCacheBundle() {
		...
		bundle.putString(TokenCachingStrategy.TOKEN_KEY, token);
	...
	private static class SerializationProxyV1 implements Serializable {
		...
		private SerializationProxyV1(String token, Date expires, List<String> permissions, AccessTokenSource source,
				Date lastRefresh) {
			this.expires = expires;
	...
	private static class SerializationProxyV2 implements Serializable {
		...
		private SerializationProxyV2(String token, Date expires, List<String> permissions,

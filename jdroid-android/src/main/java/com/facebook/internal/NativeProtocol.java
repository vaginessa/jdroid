...
public final class NativeProtocol {
	...
	public static Intent createProxyAuthIntent(Context context, String applicationId, List<String> permissions,
			String e2e) {
		Intent intent = new Intent().setClassName(FACEBOOK_APP_INFO.getPackage(), FACEBOOK_PROXY_AUTH_ACTIVITY).putExtra(
	...
	public static Intent createTokenRefreshIntent(Context context) {
		Intent intent = new Intent().setClassName(FACEBOOK_APP_INFO.getPackage(), FACEBOOK_TOKEN_REFRESH_ACTIVITY);
	...
	public static Intent createPlatformActivityIntent(Context context, String action, int version, Bundle extras) {
		...
		intent.putExtras(extras).putExtra(EXTRA_PROTOCOL_VERSION, version).putExtra(EXTRA_PROTOCOL_ACTION, action);
	...
	public static Intent createLoginDialog20121101Intent(Context context, String applicationId,
		...
		intent.putExtra(EXTRA_PROTOCOL_VERSION, PROTOCOL_VERSION_20121101).putExtra(EXTRA_PROTOCOL_ACTION,
			ACTION_LOGIN_DIALOG).putExtra(EXTRA_APPLICATION_ID, applicationId).putStringArrayListExtra(

...
/**
 * A helper class that can round trip between JSON and Bundle objects that contains the types: Boolean, Integer, Long,
 * Double, String If other types are found, an IllegalArgumentException is thrown.
 */

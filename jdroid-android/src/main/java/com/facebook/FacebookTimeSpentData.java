...
class FacebookTimeSpentData implements Serializable {
	...
	private static final long[] INACTIVE_SECONDS_QUANTA = new long[] { 5 * DateUtils.MINUTE_IN_MILLIS,
			15 * DateUtils.MINUTE_IN_MILLIS, 30 * DateUtils.MINUTE_IN_MILLIS, 1 * DateUtils.HOUR_IN_MILLIS,
			6 * DateUtils.HOUR_IN_MILLIS, 12 * DateUtils.HOUR_IN_MILLIS, 1 * DateUtils.DAY_IN_MILLIS,
			2 * DateUtils.DAY_IN_MILLIS, 3 * DateUtils.DAY_IN_MILLIS, 7 * DateUtils.DAY_IN_MILLIS,
			14 * DateUtils.DAY_IN_MILLIS, 21 * DateUtils.DAY_IN_MILLIS, 28 * DateUtils.DAY_IN_MILLIS,
			60 * DateUtils.DAY_IN_MILLIS, 90 * DateUtils.DAY_IN_MILLIS, 120 * DateUtils.DAY_IN_MILLIS,
			150 * DateUtils.DAY_IN_MILLIS, 180 * DateUtils.DAY_IN_MILLIS, 365 * DateUtils.DAY_IN_MILLIS, };
	...
	/**
	 * Serialization proxy for the FacebookTimeSpentData class. This is version 1 of serialization. Future
	 * serializations may differ in format. This class should not be modified. If serializations formats change, create
	 * a new class SerializationProxyVx.
	 */
	...
	private static class SerializationProxyV1 implements Serializable {
		...
		SerializationProxyV1(long lastResumeTime, long lastSuspendTime, long millisecondsSpentInSession,
		...
		private Object readResolve() {
			return new FacebookTimeSpentData(lastResumeTime, lastSuspendTime, millisecondsSpentInSession,
					interruptionCount);
		}
	}
	 ...
	 */
	private FacebookTimeSpentData(long lastResumeTime, long lastSuspendTime, long millisecondsSpentInSession,
			int interruptionCount
	...
	/**
	 * Serialization proxy for the FacebookTimeSpentData class. This is version 2 of serialization. Future
	 * serializations may differ in format. This class should not be modified. If serializations formats change, create
	 * a new class SerializationProxyVx.
	 */
	private static class SerializationProxyV2 implements Serializable {
		...
		SerializationProxyV2(long lastResumeTime, long lastSuspendTime, long millisecondsSpentInSession,
				int interruptionCount, String firstOpenSourceApplication
		...
		private Object readResolve() {
			return new FacebookTimeSpentData(lastResumeTime, lastSuspendTime, millisecondsSpentInSession,
					interruptionCount, firstOpenSourceApplication);
		}
	}
	...
	private Object writeReplace() {
		return new SerializationProxyV2(lastResumeTime, lastSuspendTime, millisecondsSpentInSession, interruptionCount,
	...
	private void logAppDeactivatedEvent(AppEventsLogger logger, long interruptionDurationMillis) {
		...
		eventParams.putString(AppEventsConstants.EVENT_NAME_TIME_BETWEEN_SESSIONS,
		...
		logger.logEvent(AppEventsConstants.EVENT_NAME_DEACTIVATED_APP,
			(millisecondsSpentInSession / DateUtils.SECOND_IN_MILLIS), eventParams);
		resetSession();
	}

...
public class LikeView extends FrameLayout {
	...
	public enum Style {
		/**
		 * Setting the attribute to this value will display the button and a sentence near it that describes the social
		 * sentence for the associated object.
		 *
		...
		/**
		 * Setting the attribute to this value will display the button and a box near it with the number of likes for
	...
	public enum HorizontalAlignment {
		...
		/**
		 * Setting the attribute to this value will right-justify the button and auxiliary view in the parent view. If
		 * the facebook:auxiliary_view_position is set to INLINE, then the auxiliary view will be on the left of the
		 * button
		 */
		RIGHT("right", 2);
	...
	public enum AuxiliaryViewPosition {
		/**
		 * Setting the attribute to this value will put the social-sentence or box-count below the like button. If the
		 * facebook:style is set to BUTTON, then this has no effect.
		 *
		 * This is the default value
		 */
		BOTTOM("bottom", 0),
		 ...
		 * The auxiliary view will be to the left of the button if the facebook:horizontal_alignment is set to RIGHT. In
		 * all other cases, it will be to the right of the button. If the facebook:style is set to BUTTON, then this has
		 * no effect.
		 */
		INLINE("inline", 1),
		
		/**
		 * Setting the attribute to this value will put the social-sentence or box-count above the like button. If the
		 * facebook:style is set to BUTTON, then this has no effect.
		 */
		TOP("top", 2);
	 ...
	 * onActivityResult method, to process any pending like actions, where tapping the button had resulted in the Like
	 * dialog being shown in the Facebook application.
	 *
	...
	/**
	 * Sets the facebook:foreground_color for this LikeView. Can be changed during runtime. The color is only used for
	 * the social sentence text.
	 * 
	...
	private void parseAttributes(AttributeSet attrs) {
		...
		auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(a.getInt(
			R.styleable.com_facebook_like_view_auxiliary_view_position, AuxiliaryViewPosition.DEFAULT.getValue()));
	...
	private void initialize(Context context) {
		...
		LayoutParams containerViewLayoutParams = new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
	...
	private void updateLayout() {
		...
		if ((auxiliaryViewPosition == AuxiliaryViewPosition.TOP)
				|| ((auxiliaryViewPosition == AuxiliaryViewPosition.INLINE) && (horizontalAlignment == HorizontalAlignment.RIGHT))) {
	...
	private void updateBoxCountCaretPosition() {
		switch (auxiliaryViewPosition) {
			...
			case BOTTOM:
				...
				break;
			case INLINE:
				likeBoxCountView.setCaretPosition(horizontalAlignment == HorizontalAlignment.RIGHT ? LikeBoxCountView.LikeBoxCountViewCaretPosition.RIGHT

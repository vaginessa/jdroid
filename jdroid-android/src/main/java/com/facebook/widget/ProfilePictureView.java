...
public class ProfilePictureView extends FrameLayout {
	...
	private void initialize(Context context) {
		...
		LayoutParams imageLayout = new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
	...
	private void setBlankProfilePicture() {
		if (customizedDefaultProfilePicture == null) {
			...
			Bitmap scaledBitmap = Bitmap.createScaledBitmap(customizedDefaultProfilePicture, queryWidth, queryHeight,
				false);
	...
	private void sendImageRequest(boolean allowCachedResponse) {
		try {
			...
			ImageRequest request = requestBuilder.setAllowCachedRedirects(allowCachedResponse).setCallerTag(this).setCallback(

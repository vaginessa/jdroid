...
public class AppLinkData {
	...
	private static void fetchDeferredAppLinkFromServer(Context context, String applicationId,
			final CompletionHandler completionHandler) {
		...
		Utility.setAppEventAttributionParameters(deferredApplinkParams,
			...
			Utility.getHashedDeviceAndAppID(context, applicationId), Settings.getLimitEventAndDataUsage(context));
		...
		try {
			Request deferredApplinkRequest = Request.newPostRequest(null, deferredApplinkUrlPath,
				deferredApplinkParams, null);
	...
	/**
	 * The full set of arguments for this app link. Properties like target uri & ref are typically picked out of this
	 * set of arguments.
	 * 
	...
	public interface CompletionHandler {
		...
		/**
		 * This method is called when deferred app link data has been fetched. If no app link data was found, this

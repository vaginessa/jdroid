 ...
 * intersect with rounded corners. Instead, it adds padding to avoid such intersection (See
...
public class CardView extends FrameLayout implements CardViewDelegate {
	 ...
	 * <p>
	 * Since setting this flag to true adds unnecessary gaps in the UI, default value is <code>false</code>.
	 *
	...
	public void setShadowPadding(int left, int top, int right, int bottom) {
		...
		super.setPadding(left + mContentPadding.left, top + mContentPadding.top, right + mContentPadding.right, bottom

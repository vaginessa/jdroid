...
public class UploadApkWithListing {
	...
	public static void main(String[] args) {
		try {
			...
			final AbstractInputStreamContent apkFile = new FileContent(AndroidPublisherHelper.MIME_TYPE_APK, new File(
					apkPath));
			...
			Apklistings.Update updateRecentChangesRequest = edits.apklistings().update(ApplicationConfig.PACKAGE_NAME,
				editId, apk.getVersionCode(), Locale.US.toString(), newApkListing);

...
public class AbstractJdroidAppGlideModule extends AppGlideModule {
	
	@Override
	public void applyOptions(Context context, GlideBuilder builder) {
		super.applyOptions(context, builder);
		
		GlideExecutor.UncaughtThrowableStrategy uncaughtThrowableStrategy = new JdroidUncaughtThrowableStrategy();

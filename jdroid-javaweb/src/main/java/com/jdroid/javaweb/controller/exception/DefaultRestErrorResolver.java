...
public class DefaultRestErrorResolver implements RestErrorResolver, MessageSourceAware, InitializingBean {
	...
	private static final Logger LOGGER = LoggerUtils.getLogger(DefaultRestErrorResolver.class);
	...
	protected final Map<String, String> createDefaultExceptionMappingDefinitions() {
		...
		applyDef(exceptionMappings, "org.springframework.dao.DataIntegrityViolationException", HttpStatus.CONFLICT);

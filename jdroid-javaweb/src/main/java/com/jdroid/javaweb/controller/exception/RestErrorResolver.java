...
/**
 * A {@code RestErrorResolver} resolves an exception and produces a {@link RestError} instance that can be used to
 * render a Rest error representation to the response body.
 * 
